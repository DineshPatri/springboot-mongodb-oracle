package com.home.springbootmongodboracle.service;

import com.home.springbootmongodboracle.document.Course;
import com.home.springbootmongodboracle.entity.Student;
import com.home.springbootmongodboracle.model.CourseModel;
import com.home.springbootmongodboracle.model.StudentModel;
import com.home.springbootmongodboracle.repository.CourseRepository;
import com.home.springbootmongodboracle.repository.StudentRepository;
        ...
        if (studentRepository.existsByEmail(studentModel.getEmail())){ //Check for availability of resource by email ID. Update if resource exists.
            ...
            try {
                ...
                for (int i = 0; i < studentModel.getCourses().size(); i++){
                    BeanUtils.copyProperties(studentModel.getCourses().get(i),courses.get(i));// logic to be replace to adopt adding new course when updating. or else indexoutofbound exception will come
                }
